...
public class MinutesFunction extends BuiltInFunction implements Factor {

	private Factor numericValue;

	public MinutesFunction(String functionName) {
		super(functionName);
	}
	...
	public void generateFactor(ParseTree parseTree) {
		RpgParser.ExpressionContext expressionContext = ((RpgParser.Bif_minutesContext) parseTree).minutes;
