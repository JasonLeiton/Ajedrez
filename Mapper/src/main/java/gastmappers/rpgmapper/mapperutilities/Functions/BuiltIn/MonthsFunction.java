...
public class MonthsFunction extends BuiltInFunction implements Factor {

	private Factor numericValue;

	public MonthsFunction(String functionName) {
		super(functionName);
	}
	...
	public void generateFactor(ParseTree parseTree) {
		RpgParser.ExpressionContext expressionContext = ((RpgParser.Bif_monthsContext) parseTree).numberexpression;
