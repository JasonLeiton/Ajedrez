...
public class YearsFunction extends BuiltInFunction implements Factor {

	private Factor numericValue;

	public YearsFunction(String functionName) {
		super(functionName);
	}
	...
	public void generateFactor(ParseTree parseTree) {
		RpgParser.ExpressionContext expressionContext = ((RpgParser.Bif_yearsContext) parseTree).numberexpression;
