...
public class MSecondsFunction extends BuiltInFunction implements Factor {

	private Factor numericValue;

    public MSecondsFunction(String functionName) {
        super(functionName);
    }
    ...
    public void generateFactor(ParseTree parseTree) {
        RpgParser.ExpressionContext expressionContext = ((RpgParser.Bif_msecondsContext) parseTree).numberexpression;
